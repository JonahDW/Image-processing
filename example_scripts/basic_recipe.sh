...
do
    ...
    python $sf_path'catalog_matching.py' $source'_bdsfcat.fits' NVSS --flux --astro --output --annotate ds9 --annotate_nonmatched
    python $sf_path'catalog_matching.py' $source'_bdsfcat.fits' FIRST --flux --astro --output --annotate ds9 --annotate_nonmatched
    python $sf_path'catalog_matching.py' $source'_bdsfcat.fits' SUMSS --flux --astro --output --annotate ds9 --annotate_nonmatched
...
python $sf_path'combine_catalogs.py' ${catalogs[@]} 'MALS_combined_catalogs.fits' --mode 'vstack'
python $sf_path'catalog_analysis.py' 'MALS_combined_catalogs.fits' --stacked_catalog --fancy
